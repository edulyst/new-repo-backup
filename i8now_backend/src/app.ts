 ...
 *  Routes: /auth, /shifts, /timesheets, /workers, /admin, /employer, /student
 * ═══════════════════════════════════════════════════════════════════════════ */
...
import { employerRouter } from './resources/employer/employer.routes.js'
import { studentRouter } from './resources/student/student.routes.js'
import { uploadRouter } from './resources/upload/upload.routes.js'
...
export function createApp(logger: Logger) {
  ...
  app.use(`${API_PREFIX}/employer`, employerRouter)
