...
import { ensureNotificationChannels } from './resources/notification/notification.service.js'
import { startNotificationWorker } from './resources/notification/notification.worker.js'
...
async function main(): Promise<void> {
  ...
  if (env.NOTIFICATIONS_QUEUE_ENABLED) {
    ...
    logger.info('[notification-worker] disabled (NOTIFICATIONS_QUEUE_ENABLED=false)')
  }
