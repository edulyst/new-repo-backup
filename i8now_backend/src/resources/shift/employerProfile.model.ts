...
const employerProfileSchema = new mongoose.Schema(
  {
    ...
    /**
     * Primary contact / seat role within this company account (not the same as `User.role`).
     * Used for future multi-user employer teams and UI labels.
     */
    role: {
      type: String,
      enum: ['owner', 'admin', 'recruiter', 'billing', 'viewer'],
      default: 'owner',
    },
