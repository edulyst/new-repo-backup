...
const NOTIFICATION_TYPES = [
    {
        id: 'new-shifts',
        label: 'New and upcoming shift notifications',
        description: 'Get notified when new shifts become available or when shifts you\'re interested in are starting soon',
    },
    {
        id: 'messages',
        label: 'Messages',
        description: 'Receive notifications for new messages from teams and employers',
    },
    {
        id: 'shift-updates',
        label: 'Shift updates',
        description: 'Notifications about changes to your scheduled shifts, cancellations, or confirmations',
    },
    {
        id: 'payments',
        label: 'Payment notifications',
        description: 'Get notified when payments are processed or when you receive earnings',
    },
    {
        id: 'profile-updates',
        label: 'Profile updates',
        description: 'Notifications about profile verification, updates, or important account changes',
    },
];
...
export default function NotificationTypeScreen() {
    ...
    const displayValue =
        selectedTypesArray.length === 0
            ? 'None selected'
            : selectedTypesArray
                  .map((id) => NOTIFICATION_TYPES.find((t) => t.id === id)?.label)
                  .filter(Boolean)
                  .join(', ');
        ...
        <View style={styles.screen}>
            ...
            <SafeAreaView style={styles.safe} edges={['left', 'right', 'bottom']}>
                ...
                <Animated.View style={[styles.header, { paddingTop: insets.top }, fade(headerAnim, -10)]}>
                    ...
                    <Text style={styles.hTitle}>Type</Text>
                    ...
                    <Animated.View style={fade(contentAnim, 22)}>
                        ...
                        <View style={styles.section}>
                            <Text style={styles.description}>
                                Choose which types of notifications you want to receive. You can customize your notification preferences for different activities and updates.
                            </Text>
                        </View>
                        ...
                        <View style={styles.section}>
                            <View style={styles.summaryCard}>
                                <Text style={styles.summaryLabel}>Selected types</Text>
